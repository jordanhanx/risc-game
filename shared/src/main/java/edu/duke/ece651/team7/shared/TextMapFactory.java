...
<<<<<<< HEAD
        ...
        // Territory territory2 = new Territory("Elantris", initGroupOwners.get(0), 0);
        // Territory territory3 = new Territory("Midkemia", initGroupOwners.get(0), 0);
        // Territory territory4 = new Territory("Oz", initGroupOwners.get(1), 0);
...
public GameMap createTwoPlayersMap(){
        ...
        map.addTerritoryAndNeighbors(territory4, territory1, territory2, territory5, territory6, territory10, territory11);
        map.addTerritoryAndNeighbors(territory5, territory2, territory3, territory4, territory6, territory7, territory11, territory12);
        ...
        map.addTerritoryAndNeighbors(territory11,territory2, territory3, territory4, territory5, territory8, territory14, territory19, territory17);
        map.addTerritoryAndNeighbors(territory12, territory6, territory7, territory21, territory22, territory24, territory5);
