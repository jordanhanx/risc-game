...
public class PathCheckerTest {
        ...
        public void test_checkMyrule() {
                ...
                assertEquals("Access Denied: source Territory does not belong to you",
                                checker.checkOrderValidity(map, m1));

                MoveOrder m2 = new MoveOrder(p1, map.getTerritoryByName("Midkemia"), map.getTerritoryByName("Narnia"),
                                3);
                ...
                assertEquals("Access Denied: destination Territory does not belong to you",
                                checker.checkOrderValidity(map, m3));
                ...
                AttackOrder a2 = new AttackOrder(p1, map.getTerritoryByName("Narnia"),
                                map.getTerritoryByName("Midkemia"), 10);
