...
public class Combat {
    ...
    public boolean doOneUnitCombat(Player defender, Player attacker) {
        ...
        // getAttackUnitofPlayer(attacker) + ") "
    ...
    public Player resolveCombat() {
        ...
        while (true) {
            ...
            if (combatEnd()) { // combats end
                // System.out.println("Winner is " + participants.get(0) + " with " +
                // attackPool.get(participants.get(0)) + " units");
                ...
                System.out.println("Winner of Combat in " + battleField.getName() + " (" + battleField.getUnits()
                        + ") is: " + participants.get(0).getName());
